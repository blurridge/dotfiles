...
-- Enable smart indenting for braces and other code blocks
vim.opt.smartindent = true   -- Makes indent smartly follow the code structure
vim.opt.autoindent = true    -- Automatically sets the indent of a new line to the same as the line just typed
  ...
  },
  {
    ...
    config = function()
      require('presence').setup {
        ...
        neovim_image_text = 'Struggling with vim help me', -- Text displayed when hovered over the Neovim image
    ...
    config = function()
      ...
      cmp.setup {
        ...
        sources = {
          ...
          { name = 'luasnip' },
          { name = 'path' },
          { name = 'emoji' }, -- Ensure the emoji source is explicitly listed
        },
      }
    end,
  },
